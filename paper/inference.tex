...
We first observe that true the posterior distribution can be written as:
\begin{align}
...
the true posteriors.
The quality of aproximation depends entirely on the posterior over the inducing variables, thus underlining their pivotal role in the model as previously discussed.
...
then substituting these into Equation \eqref{eq:elbo}. (Please see 
