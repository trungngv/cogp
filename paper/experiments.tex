...
The real data and the predictive distributions by 3 models (COGP, CGP with exact inference \citet{alvarez-lawrence-nips-08}, and independent GPs) are shown in Figure \ref{fig:weather}.
